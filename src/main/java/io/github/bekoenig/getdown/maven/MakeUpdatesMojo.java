...
public class MakeUpdatesMojo extends AbstractGetdownMojo {
    ...
    private final List<Artifact> packagedJnlpArtifacts = new ArrayList<>();
    ...
    protected void makeConfigFile() throws FileNotFoundException {
        try (PrintWriter writer = new PrintWriter(new File(workDirectory, "getdown.txt"))) {
