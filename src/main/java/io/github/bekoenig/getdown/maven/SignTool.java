...
public interface SignTool {
     ...
     * @param workingKeystore location where to copy keystore if coming from an url or from
     *                        classpath
     ...
     * @param signedJar optional location of the signed jar to produce (if not set,
